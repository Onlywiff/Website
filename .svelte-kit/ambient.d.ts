...
declare module '$env/static/private' {
	...
	export const FLEET_BACKEND_PROPERTIES: string;
	export const FLEET_BACKEND_VM_OPTIONS: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		DEBUG_COLORS: string;
		DriverData: string;
		FLEET_BACKEND_PROPERTIES: string;
		FLEET_BACKEND_VM_OPTIONS: string;
		FORCE_COLOR: string;
		HOMEDRIVE: string;
		HOMEPATH: string;
		HOMESHARE: string;
